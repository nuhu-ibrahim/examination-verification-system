 ...
 * @author NUHU
 */
public class ResultSignOut extends javax.swing.JInternalFrame {

    /**
     * Creates new form Result
     */
    ExamSignOut main;
    public ResultSignOut(ExamSignOut main) {
        this.main = main;
        DBConnection.connect();
        initComponents();
        try{
            PreparedStatement st;
            String sql1= "select * from student_pass, student_info where student_pass.reg_no=? and student_pass.reg_no = student_info.reg_no";
            ...
            if (DBConnection.rs.next()){
                ...
                regNum1.setText(DBConnection.rs.getString("student_info.reg_no"));
    ...
    private void initComponents() {
        ...
        setPreferredSize(new java.awt.Dimension(503, 550));
        setVisible(true);
        ...
        update.setText("Sign Out");
        update.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                updateActionPerformed(evt);
            }
        });
        getContentPane().add(update, new org.netbeans.lib.awtextra.AbsoluteConstraints(150, 480, 190, -1));
        ...
        getContentPane().add(program, new org.netbeans.lib.awtextra.AbsoluteConstraints(160, 430, 310, 30));
    ...
    private void updateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_updateActionPerformed
        try{
            ...
            String sql = "update exam_sign_in set sign_out_time = ?, sign_out = ?  where reg_no = ? AND exam_id = ?";
            st = DBConnection.con.prepareStatement(sql);
            st.setString(1, end);
            st.setString(2, end2);
            st.setString(3, main.getRegNo());
            st.setString(4, ""+main.getExamId());

            st.executeUpdate();

            sql = "insert into exam_sign_out (reg_no, exam_id) values (?,?)";
            st = DBConnection.con.prepareStatement(sql);
            st.setString(1, main.getRegNo());
            st.setString(2, main.getExamId());

            st.executeUpdate();

            JOptionPane.showMessageDialog(this, "Student signed out successfully", "Information", JOptionPane.INFORMATION_MESSAGE);
            this.dispose();
            this.hide();
        }catch(Exception ex){
            System.out.println(ex.getMessage());
