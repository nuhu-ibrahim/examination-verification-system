...
public class UploadLecturerBio extends javax.swing.JInternalFrame {

    private DPFPCapture capturer = DPFPGlobal.getCaptureFactory().createCapture();
    private DPFPEnrollment enroller = DPFPGlobal.getEnrollmentFactory().createEnrollment();
    public LecturerRegistration main;
    private DPFPTemplate template;
    
    public UploadLecturerBio(LecturerRegistration main) {
        this.main = main;
    ...
    private void initComponents() {
        ...
        next.setText("Insert Lecturer Information");
        ...
        jPanel5.add(next, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 24, 210, 30));
        ...
        jPanel5.add(validate2, new org.netbeans.lib.awtextra.AbsoluteConstraints(240, 24, -1, 30));

        jPanel1.add(jPanel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 340, 320, 70));
    ...
    public void insert() throws Exception{
        try{
            ...
            String sql = "insert into lecturer_bio (staff_id, bio) values (?,?)";
            ...
            JOptionPane.showMessageDialog(this, "Examiner successfully registered", "Lecturer Registered", JOptionPane.INFORMATION_MESSAGE);
            refresh();
    ...
    public void refresh(){
        ...
        Thread runner = new Thread() {
            ...
            public void run() {
                LecturerRegistration courseReg = new LecturerRegistration();
    ...
    private void nextActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_nextActionPerformed
        if(picture.getIcon()==null){
            JOptionPane.showMessageDialog(this, "Examiner finger print has not been captured");
        }else{
            try{
