...
public class AllLecturer extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        setClosable(true);
        setTitle("View all Lecturer Information");
        ...
        jLabel1.setText("View all Lecturer");
    ...
    private void createTable(){
        String sql="select staff_id, fname, mname, lname, dob from lecturer_info";

        JTable table;
        TableColumn column = null;
        JScrollPane scrollPane;
        String meta[]={"Staff ID", "Firstname", "Middlename", "Lastname", "Date of Birth"};
