...
public class VerifyLecturerBio extends javax.swing.JInternalFrame {
    ...
    public VerLecturerPage main;
    private DPFPTemplate template;
    private DPFPFeatureSet features;
    
    public VerifyLecturerBio(VerLecturerPage main) {
        this.main = main;
        ...
        if (features != null)
        {
            ...
            if (result.isVerified()){
                ...
                Thread runner = new Thread() {
                    ...
                    public void run() {
                        ResultLecturer1 regJ = new ResultLecturer1(VerifyLecturerBio.this);
                        desktop1.add(regJ);
                        try {
                ...
                Thread runner = new Thread() {
                    ...
                    public void run() {
                        ResultLecturer regJ = new ResultLecturer(VerifyLecturerBio.this);
                        desktop1.add(regJ);
                        try {
                            regJ.setSelected(true);
                        } catch (java.beans.PropertyVetoException e) {
    ...
    public void refresh(){
        ...
        public void run() {
            VerLecturerPage regJ = new VerLecturerPage();
            desktop1.add(regJ);
            try {
                regJ.setSelected(true);
            } catch (java.beans.PropertyVetoException e) {
