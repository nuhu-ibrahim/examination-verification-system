...
public class LecturerVerificationPage extends javax.swing.JInternalFrame {

    private DPFPCapture capturer = DPFPGlobal.getCaptureFactory().createCapture();
    private DPFPEnrollment enroller = DPFPGlobal.getEnrollmentFactory().createEnrollment();
    private DPFPVerification verificator = DPFPGlobal.getVerificationFactory().createVerification();
    public LecturerVerificationPage main;
    ...
    public LecturerVerificationPage() {
    ...
    private void initComponents() {
        ...
        setClosable(true);
        setTitle("Lecturer Verification");
        ...
        jLabel1.setText("LECTURER VERIFICATION");
    ...
    private void nextActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_nextActionPerformed
        try{
            ...
            if (features != null)
            {
                ...
                String sql = "select * from lecturer_bio";
                st = DBConnection.con.prepareStatement(sql);
                DBConnection.rs = st.executeQuery();
                while(DBConnection.rs.next()){
                    regnum = DBConnection.rs.getString("staff_id");
                    ...
                    if (result.isVerified()){
                        ...
                        ResultLecturer1 regJ = new ResultLecturer1(LecturerVerificationPage.this);
                        desktop1.add(regJ);
                        try {
                ...
                if(error){
                    ResultLecturer regJ = new ResultLecturer(LecturerVerificationPage.this);
                    desktop1.add(regJ);
                    try {
                        regJ.setSelected(true);
                    } catch (java.beans.PropertyVetoException e) {
                ...
                JOptionPane.showMessageDialog(LecturerVerificationPage.this, "No fingerprint has been captured, please capture fingerprint and try again","Information", JOptionPane.ERROR_MESSAGE);
            }
        }catch(Exception ex){
