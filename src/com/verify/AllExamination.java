...
public class AllExamination extends javax.swing.JInternalFrame {

    public AllExamination() {
        initComponents();
        createTable();
    }
    ...
    private void initComponents() {
        ...
        setClosable(true);
        setTitle("View all Examination Information");
        ...
        jLabel1.setText("View all Examinations");
    ...
    private void createTable(){
        String sql="select exam_id, course_title, course_code, exam_date, start_time, end_time from exam_info";

        JTable table;
        TableColumn column = null;
        JScrollPane scrollPane;
        String meta[]={"Exam ID", "Course Title", "Course Code", "Exam Date", "Start Time", "End Time"};
