...
public class ExamSignOut extends javax.swing.JInternalFrame {

    private DPFPCapture capturer = DPFPGlobal.getCaptureFactory().createCapture();
    private DPFPEnrollment enroller = DPFPGlobal.getEnrollmentFactory().createEnrollment();
    private DPFPVerification verificator = DPFPGlobal.getVerificationFactory().createVerification();
    public ExamSignOut main;
    ...
    private void initComponents() {
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 102, 0)), "Sign Out Information", javax.swing.border.TitledBorder.LEFT, javax.swing.border.TitledBorder.TOP, new java.awt.Font("Tempus Sans ITC", 1, 14), java.awt.Color.darkGray)); // NOI18N
        ...
        jLabel1.setText("  EXAMINATION SIGN-OUT");
        getContentPane().add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(59, 10, 340, -1));
    ...
    private void nextActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_nextActionPerformed
        if(exam.getSelectedIndex() == 0){
            ...
            try{
                ...
                String end = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss").format(today);
                String end2 = new SimpleDateFormat("HH:mm:ss").format(today);
                System.out.println(end2);

                exam.setTime(exam.getTime() + 2700000);
                boolean error = true;
                if(!today.before(exam)){
                    ...
                    if (features != null)
                    {
                        ...
                        while(DBConnection.rs.next()){
                            ...
                            if (result.isVerified()){
                                ...
                                if(DBConnection.rs.next()){
                                    sql1= "select * from exam_sign_out where reg_no = ? AND exam_id = ?";
                                    st = DBConnection.con.prepareStatement(sql1);
                                    st.setString(1, regnum);
                                    st.setString(2, ""+this.exam.getSelectedItem());
                                    ...
                                    DBConnection.rs = st.executeQuery();
                                    if(!DBConnection.rs.next()){
                                        ResultSignOut regJ = new ResultSignOut(ExamSignOut.this);
                                        desktop1.add(regJ);
                                        try {
                                        ...
                                        JOptionPane.showMessageDialog(this, "Student has already signed out", "Issue", JOptionPane.OK_OPTION);
                                    }
                                }else{
                                    JOptionPane.showMessageDialog(this, "Student was not signed in", "Issue", JOptionPane.OK_OPTION);
                                } 
                                error = false;
                            }
                        }
                        if(error){
                            ...
                            JOptionPane.showMessageDialog(ExamSignOut.this, "The fingerprint does not match any student.","Information", JOptionPane.ERROR_MESSAGE);
                        }
                    }else{
                        JOptionPane.showMessageDialog(ExamSignOut.this, "No fingerprint has been captured, please capture fingerprint and try again","Information", JOptionPane.ERROR_MESSAGE);
                    }
                }else{
                    JOptionPane.showMessageDialog(this, "Student can not sign-out before the end of the first 45 minutes", "Issue", JOptionPane.OK_OPTION);
                }
            }catch(Exception ex){
