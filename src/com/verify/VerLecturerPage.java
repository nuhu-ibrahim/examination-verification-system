 ...
 * @author NUHU
 */
public class VerLecturerPage extends javax.swing.JInternalFrame {

    /**
     * Creates new form StudentRegistration
     */
    
    public VerLecturerPage() {
    ...
    private void initComponents() {
        ...
        setClosable(true);
        setTitle("Examiner Verification");
        ...
        jLabel1.setText("EXAMINER BIOMETRIC VERIFICATION");
        getContentPane().add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(1, 10, 470, -1));
        ...
        jPanel1.add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 20, 50, 40));
        jPanel1.add(regNum, new org.netbeans.lib.awtextra.AbsoluteConstraints(90, 30, 250, 30));
            ...
            try{
                ...
                if (DBConnection.rs.next()){
                    Thread runner = new Thread() {
                        ...
                        public void run() {
                            VerifyLecturerBio regJ = new VerifyLecturerBio(VerLecturerPage.this);
                            desktop1.add(regJ);
                            try {
